...
rank, as of 2026-09-14, with no agent and no language model at inference.
The two entries above it are agentic pipelines, and every component of the
system is trained on the benchmark's training splits only. The system is a router frozen into a table. For each of the 97 dataset,
